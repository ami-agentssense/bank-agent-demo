...
from .prompts import build_agent_system_prompt, build_auth_agent_system_prompt
from .tools import make_banking_tools, make_customer_lookup_tool
...
async def _run_bank_agent_async(
    *,
    ...
    if customer is None:
        ...
        system_prompt = build_auth_agent_system_prompt(
        ...
        tools = [make_customer_lookup_tool(session), *local_tools, *mcp_tools]
